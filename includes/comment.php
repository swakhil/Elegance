                  <div class="box-comment" id="box-comment-<?php echo $row_com['cid']; ?>">
                        <a href="<?php echo select_sql_id($row_com['id_user_com'], 'username'); ?>">
                        ...
                        <div class="comment-text">
                          ...
                          <a href="<?php echo select_sql_id($row_com['id_user_com'], 'username'); ?>"><?php echo show_username(select_sql_id($row_com['id_user_com'], 'username')); ?>
                          </a>
                          <span class="text-muted pull-right">
                            ...
                            <?php //echo ReturnCommentPopFirst($row_com['id_user_com'],$row_com['cid'],'Edit','Hide', $row['pid']);?>
