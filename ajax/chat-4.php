...
if (verify_token_general($name = $id_csrf)) {
    $cvid = select_doublearg('chatting', 'id_session', returnID(), 'id_chat', '4', 'cvid');
    $id = select_doublearg('chatting', 'id_session', returnID(), 'id_chat', '4', 'id_user');
...
<script type="text/javascript">
    ...
    intervalStart_4 = setTimeout(function(){
        $.ajax({
            type : "POST",
