...
if (verify_token_general($name = $id_csrf)) {
    $cvid = select_doublearg('chatting', 'id_session', returnID(), 'id_chat', '1', 'cvid');
    $id = select_doublearg('chatting', 'id_session', returnID(), 'id_chat', '1', 'id_user');
...
<script type="text/javascript">
     ...
     intervalStart_1 = setTimeout(function(){
        $.ajax({
            type : "POST",
