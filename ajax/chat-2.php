...
if (verify_token_general($name = $id_csrf)) {
    $cvid = select_doublearg('chatting', 'id_session', returnID(), 'id_chat', '2', 'cvid');
    $id = select_doublearg('chatting', 'id_session', returnID(), 'id_chat', '2', 'id_user');
...
<script type="text/javascript">
    ...
    intervalStart_2 = setTimeout(function(){
        $.ajax({
            type : "POST",
